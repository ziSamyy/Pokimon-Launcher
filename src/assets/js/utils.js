...
function addAccount(data) {
	...
	div.innerHTML = `
        <div class="account-image-container">
            <img class="account-image" src="https://account.sakuralivemc.com/avatar/player/${data.name}?2d&size=100">
        </div>
...
function headplayer(pseudo) {
	document.querySelector(
		'.player-head'
	).style.backgroundImage = `url(https://account.sakuralivemc.com/avatar/player/${pseudo}?2d&size=100)`
}
